...
def predict(to_predict_dict_short, to_predict_dict_long, long):
    """iterates the dictionaries into the prediction functions
    ...
    -------
    csv
        saves csv with prediction to predicciones/entregable/

    csv 
        saves csv with prediction and detailed data to predicciones/
